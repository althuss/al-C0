...
static const std::pair<int, int> kQueenMoves[] = {
    {-1, -1}, {-1, 1}, {1, -1}, {1, 1}};
...
static const BitBoard kBishopAttacks[] = {
    0x0000000000000000ULL, 0x0000000000080000ULL, 0x0000000000110000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000000880000ULL,
    0x0000000000100000ULL, 0x0000000000000000ULL, 0x0000000004000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000000022000000ULL,
    0x0000000044000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000000020000000ULL, 0x0000000400000004ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000002200000022ULL, 0x0000004400000044ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000002000000020ULL,
    0x0000000000000000ULL, 0x0000080000000800ULL, 0x0000110000001100ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL, 0x0000880000008800ULL,
    0x0000100000001000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0008000000080000ULL, 0x0011000000110000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0088000000880000ULL, 0x0010000000100000ULL,
    0x0000000000000000ULL, 0x0400000004000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x2200000022000000ULL, 0x4400000044000000ULL,
    0x0000000000000000ULL, 0x0000000000000000ULL, 0x2000000020000000ULL,
    0x0000000400000000ULL, 0x0000000000000000ULL, 0x0000000000000000ULL,
    0x0000002200000000ULL, 0x0000004400000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000002000000000ULL, 0x0000000000000000ULL,
    0x0000080000000000ULL, 0x0000110000000000ULL, 0x0000000000000000ULL,
    0x0000000000000000ULL, 0x0000880000000000ULL, 0x0000100000000000ULL,
    0x0000000000000000ULL};


// Which squares can queen attack.
static const BitBoard kQueenAttacks[] = {
    ...
    0x000000000000A000ULL, 0x0000000000004000ULL, 0x0000000000020002ULL,
    0x0000000000050005ULL, 0x00000000000A000AULL, 0x0000000000140014ULL,
    0x0000000000280028ULL, 0x0000000000500050ULL, 0x0000000000A000A0ULL,
    0x0000000000400040ULL, 0x0000000002000200ULL, 0x0000000005000500ULL,
    0x000000000A000A00ULL, 0x0000000014001400ULL, 0x0000000028002800ULL,
    0x0000000050005000ULL, 0x00000000A000A000ULL, 0x0000000040004000ULL,
    0x0000000200020000ULL, 0x0000000500050000ULL, 0x0000000A000A0000ULL,
    0x0000001400140000ULL, 0x0000002800280000ULL, 0x0000005000500000ULL,
    0x000000A000A00000ULL, 0x0000004000400000ULL, 0x0000020002000000ULL,
    0x0000050005000000ULL, 0x00000A000A000000ULL, 0x0000140014000000ULL,
    0x0000280028000000ULL, 0x0000500050000000ULL, 0x0000A000A0000000ULL,
    0x0000400040000000ULL, 0x0002000200000000ULL, 0x0005000500000000ULL,
    0x000A000A00000000ULL, 0x0014001400000000ULL, 0x0028002800000000ULL,
    0x0050005000000000ULL, 0x00A000A000000000ULL, 0x0040004000000000ULL,
    0x0200020000000000ULL, 0x0500050000000000ULL, 0x0A000A0000000000ULL,
    0x1400140000000000ULL, 0x2800280000000000ULL, 0x5000500000000000ULL,
    0xA000A00000000000ULL, 0x4000400000000000ULL, 0x0002000000000000ULL,
...
MoveList ChessBoard::GeneratePseudolegalMoves() const {
  ...
  continue;
   ...
   if (queens_.get(source)) {
      processed_piece = true; 
      for (const auto& delta : kQueenMoves) {
        const auto dst_row = source.row() + delta.first;
        const auto dst_col = source.col() + delta.second;
        if (!BoardSquare::IsValid(dst_row, dst_col)) continue;
        const BoardSquare destination(dst_row, dst_col);
...
//        break;
 ...
 // }
  ...
  queens_.set_if(to, queens_.get(from));
...
bool ChessBoard::IsUnderAttack(BoardSquare square) const {
  ...
  // Check queens.
  if (kQueenAttacks[square.as_int()].intersects(their_pieces_ & queens_)) {
     return true;
   }
...
KingAttackInfo ChessBoard::GenerateKingAttackInfo() const {
  ...
  const BitBoard attacking_bishops =
    kBishopAttacks[our_king_.as_int()] & their_pieces_ & bishops_;
king_attack_info.attack_lines_ =
    king_attack_info.attack_lines_ | attacking_bishops;

if (attacking_bishops.as_int()) {
  // No more than one bishop can give check.
  num_king_attackers++;
}

   // Check queens
const BitBoard attacking_queens =
kQueenAttacks[our_king_.as_int()] & their_pieces_ & queens_;
king_attack_info.attack_lines_ =
king_attack_info.attack_lines_ | attacking_queens;

if (attacking_queens.as_int()) {
  // No more than one queen can give check.
  num_king_attackers++;
}
  ...
  const BitBoard attacking_knights =
      ...
      (their_pieces_ - their_king_ - rooks_ - bishops_ - queens_ - (pawns_ & kPawnMask));
  king_attack_info.attack_lines_ =
...
bool ChessBoard::HasAnyPieces() const {
  if ((our_pieces_).count() < 2 || (their_pieces_).count() < 2 ) {
   std::cout << "I checked HasAnyPieces";
   return false;
 }
}
